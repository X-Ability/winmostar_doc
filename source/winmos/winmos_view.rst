...
キーワード&座標表示エリアを表示
-----------------------------------
   メインウインドウでキーワード表示エリアと座標表示エリアの表示・非表示を切り替えます。
...
自由回転
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   メインウインドウで左ドラッグすると、注視点を中心にカメラが回転します。

X, Y, Z軸周りで回転
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   メインウインドウで左ドラッグすると、各軸の周りでカメラが回転します。

表示を回転
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   メインウインドウで左ドラッグすると、表示が回転します。
