...
結晶構造を作成します。主に以下の目的で使用します。
   ...
   OK
      作成した結晶構造をメインウインドウに読み込みます。
      
      読み込みを取り消したい場合は、メインウインドウで :menuselection:`編集 --> 元に戻る` をクリックしてください。
   Cancel
      結晶ビルダで入力した構造を破棄しメインウインドウに戻ります。

スーパーセルを作成
------------------------
メインウインドウで表示されているセルを複製しスーパーセルを作成します。
...
格子を変換
------------------------
メインウインドウで表示されているセルについて、プリミティブセル-コンベンショナルセル間の変換を行います。
