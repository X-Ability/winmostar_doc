...
- 使用中のWinmostarが無償版、学生版、トライアル版、プロフェッショナル版のいずれに該当するか確認し、問題を起こしている機能がその版で使用可能か `機能表 <https://winmostar.com/jp/function_jp.html>`_ を見て確認する。
...
| A. :ref:`intro_recommend_spec` をご確認下さい。
...
| A. 引用については :ref:`intro_citation` に記載しています。
