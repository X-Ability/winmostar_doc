...
| A. GAMESSでは閉殻のHartree-FockしかNMR計算に対応していません。また、GAMESSのNMR計算の実行速度は遅いです。代わりにNWChemやGaussianを使うことをお勧めします。
| どうしてもWinmostarからGAMESSで計算したい場合は、SetupウインドウのAdvancedタブの$SCF欄のDIRSCFのチェックを全て外して、並列数は1にしてください。 
